...
\reporttitle{Model report} % The report title to appear on the title page and page headers, do not create manual new lines here as this will carry over to page headers
...
\input{hoofdstukken/0_introduction.tex}
\newpage
\input{hoofdstukken/1_baseline_performance.tex}
\newpage
\input{hoofdstukken/2_overview.tex}
\newpage
\input{hoofdstukken/3_reasoning.tex}
\newpage
\input{hoofdstukken/4_implementing.tex}
