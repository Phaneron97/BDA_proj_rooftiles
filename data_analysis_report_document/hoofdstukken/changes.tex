...
% 	%
% 	\begin{subfigure}
% 		\includegraphics[width=\linewidth]{horizontal_flip.jpg}
% 		\caption{After}
% 		\label{fig:horizontal_flip}
% 	\end{subfigure}
% 	\label{fig:comparison}
...
\sidenote{Similar to flipping, but now done vertically. 
...
\sidenote{A copy of the original image from the dataset gets rotated version.
