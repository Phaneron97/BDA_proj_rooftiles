# -*- coding: utf-8 -*-
"""vgg_models_train.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1QukfEQKwSZUM4XawHFAHRRnQFQLVRqdJ
"""

learning_rate = 0.001
number_of_train_epochs = 20

model_name = "vgg19_bn" # vgg{11,11_bn,13,13_bn,16,16_bn,19,19_bn}
...
# vgg{11,11_bn,13,13_bn,16,16_bn,19,19_bn} available.
def model_creator(model_name, num_classes, freeze_conv_layers=True):
  ...
  if model_name == "vgg11_bn":
    model = torchvision.models.vgg11_bn(pretrained=True, progress=True)
  if model_name == "vgg13":
    model = torchvision.models.vgg13(pretrained=True, progress=True)
  if model_name == "vgg13_bn":
    model = torchvision.models.vgg13_bn(pretrained=True, progress=True)
  if model_name == "vgg16":
