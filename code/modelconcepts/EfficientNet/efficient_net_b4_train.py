...
weights = torchvision.models.EfficientNet_B4_Weights
model = torchvision.models.efficientnet_b4(weights=weights, progress=True)
print(model)
...
#Result of efficientnet_b4 test:
