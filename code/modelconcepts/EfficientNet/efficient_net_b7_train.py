...
weights = torchvision.models.EfficientNet_B7_Weights
model = torchvision.models.efficientnet_b7(weights=weights, progress=True)
print(model)
...
#Result of efficientnet_b7 test:
#random accuracy = 5.555555555555555
#Test Accuracy: 61.46788990825688%
