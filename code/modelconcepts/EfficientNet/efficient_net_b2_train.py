...
model = torchvision.models.efficientnet_b2(weights=weights, progress=True)
print(model)
...
#Result of efficientnet_b2 test:
#random accuracy = 5.555555555555555
#Test Accuracy: 66.05504587155963%
