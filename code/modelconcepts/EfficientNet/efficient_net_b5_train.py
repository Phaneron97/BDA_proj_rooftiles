...
weights = torchvision.models.EfficientNet_B5_Weights
model = torchvision.models.efficientnet_b5(weights=weights, progress=True)
print(model)
...
#Result of efficientnet_b5 test:
#random accuracy = 5.555555555555555
#Test Accuracy: 56.88073394495413%
