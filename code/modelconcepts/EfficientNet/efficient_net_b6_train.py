...
weights = torchvision.models.EfficientNet_B6_Weights
model = torchvision.models.efficientnet_b6(weights=weights, progress=True)
print(model)
...
#Result of efficientnet_b6 test:
#random accuracy = 5.555555555555555
#Test Accuracy: 58.71559633027523%
